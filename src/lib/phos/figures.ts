...
export const FIGURES: Figure[] = [
  // ── the Hidden Ecology of Formation, in twenty-four figures ──────────────
  { k: "The Provinces", C: drawing("ProvincesAtlas"), rel: "spatial", teaching: "The Hidden Ecology",
    d: "The six stations as a ring, and around them the provinces: the Sea every mediation happens in, the Nursery before form, the Aquifer beneath, the Catacombs after the cult, the Garden where residue acquires allure, the hungry form at the waterline.",
    not: "Not a map of places. Above, beneath and beside are relations to the circulation, not directions in space." },
  { k: "A God Is an Architecture", C: drawing("SacredArchitectureLayers"), rel: "hierarchical", teaching: "The Hidden Ecology",
    d: "A deity as encountered: source, mediating current, morphal body, astral clothing, and the rite, temple, statue and attention that give it a place to stand — and the same house with its inhabitant withdrawn.",
    not: "Not a claim that the god is the house. The drawing exists to keep them apart: the statue can be broken without the god being destroyed, and the house can go on moving after the god has gone." },
  { k: "The Unequal Deaths", C: drawing("UnequalDeaths"), rel: "causal", teaching: "The Hidden Ecology",
    d: "Five deaths of a sacred form — liturgical, social, imaginal, aetheric, daimonic — as five bars that break at different points.",
    not: "None guarantees the others. A deity can be socially forgotten and imaginally potent; a power can be fully real while every form once used to approach it is obsolete." },
  { k: "The Broken Circuit", C: drawing("BrokenCircuit"), rel: "cyclical", teaching: "The Hidden Ecology",
    d: "A lawful exchange that receives, transforms, gives and returns, beside a hungry form that takes in and accumulates without return: proodos without epistrophē.",
    not: "Not a portrait of an entity. Hunger is a disorder of relationship, and the drawing shows the relation, not a creature." },
  { k: "The Feedback Loop", C: drawing("FeedbackLoop"), rel: "cyclical", teaching: "The Hidden Ecology",
    d: "People form an atmosphere; the atmosphere selects feelings; feelings guide action; action alters the habitat; the habitat recruits. What began as expression becomes environment.",
    not: "Not a proof that the loop is conscious. Distributed agency can act with formidable consistency without being a person in the invisible world." },
  { k: "Gestation and Its Failures", C: drawing("GestationAndItsFailures"), rel: "causal", teaching: "The Hidden Ecology",
    d: "From confluence to birth — aitherogenesis, aitherostasis, hierostasis, the four thresholds — with the exits at each: resorbed into Morphaithēr, returned to the Aquifer, a bone to the Ossuary, a consequence to the Crypt, or a scar.",
    not: "Not every failed gestation is a tragedy. Some forms are wisely resorbed; failure is dangerous chiefly when an arrested form refuses dissolution." },
  { k: "The Anatomy of a Bloom", C: drawing("CounterfeitBloom"), rel: "symbolic", teaching: "The Hidden Ecology",
    d: "A flower labelled by what each part argues: colour as correspondence, fragrance as affect, nectar as reward, thorns as the penalty on doubt — and below the ground the root it feeds from and the fruit it bears.",
    not: "Only the fruit reveals the whole plant. Beauty, radiance, antiquity and power are not tests of truth." },
  { k: "The Species of the Garden", C: drawing("SixSpecies"), rel: "symbolic", teaching: "The Hidden Ecology",
    d: "Six counterfeit flowers as six glyphs: the Mirror, the Relic, the Grafted, the Orphan, the Hungry and the Premature.",
    not: "Not six kinds of lie. The Orphan is a real encounter wrongly named, and the Premature is a genuine future imprisoned in a false present." },
  { k: "The Sea Between Causes", C: drawing("SeaBetweenCauses"), rel: "analogical", teaching: "The Hidden Ecology",
    d: "Currents of intention, memory, vitality, image, inheritance and choice crossing the astral, etheric and material media, refracted by each, meeting at confluences, caught in an eddy, laying sediment, and arriving together at one shore: the effect.",
    not: "Not a chain. The nearest cause to an outcome is often only the gate through which older causes emerged." },
  ...
  { k: "Differential Reception", C: drawing("DifferentialReception"), rel: "causal", teaching: "The Hidden Ecology",
    d: "One identical force entering three vessels — open, saturated, resistant — and three manifestations emerging.",
    not: "The force is drawn identical on purpose. Nothing that differs is on the giving side." },
  { k: "One Current, Many Expressions", C: drawing("OneCurrentManyExpressions"), rel: "analogical", teaching: "The Hidden Ecology",
    d: "The Sap of Heaven as a delta: one descent dividing by reception into ten expressions.",
    not: "The forks are differences in the receiver, not decisions in the source, and no branch is a degraded copy of another." },
  { k: "Hydrological Sequence", C: drawing("HydrologicalSequence"), rel: "cyclical", teaching: "The Hidden Ecology",
    d: "Nine stations of healthy circulation on a ring, and five failures leaving it as a chain of dead ends.",
    not: "The failures are exits, not stages. Accumulation and saturation on the ring are not among them." },
  { k: "Etheric Watershed", C: drawing("EthericWatershed"), rel: "spatial", teaching: "The Hidden Ecology",
    d: "One catchment carrying the hydrological vocabulary: spring, channel, confluence, threshold, filter, reservoir, dam, delta, and the three failures as places.",
    not: "A watershed is not the water. None of the twelve terms is the current; each is a relation the current has to architecture." },
  { k: "Erosion Series", C: drawing("ErosionSeries"), rel: "causal", teaching: "The Hidden Ecology",
    d: "Four cross-sections under the same current, from a wet trace to a canyon.",
    not: "The water is identical in every frame. What changes is the ground, which then decides where the water goes." },
  { k: "Form at the Intersection", C: drawing("FormAtTheIntersection"), rel: "spatial", teaching: "The Hidden Ecology",
    d: "Five lines converging on the outline of a vessel — condition, nourishment, circulation, inheritance, memory — and six verbs leaving it.",
    not: "The vessel is open above and below on purpose. A closed one would be a tomb, not a form." },
  { k: "Captive Light Progression", C: drawing("CaptiveLightProgression"), rel: "causal", teaching: "The Hidden Ecology",
    d: "A current passing through an open architecture; the same architecture closed, with the current circling inside it.",
    not: "One line separates the frames. Captivity is not a different structure from service; it is service closed." },
  { k: "Spolia", C: drawing("Spolia"), rel: "analogical", teaching: "The Hidden Ecology",
    d: "A ruined colonnade, and a later wall built from its blocks — the same stones in gold in both places.",
    not: "Not a picture of decline. The quarrying is how forms have always inherited, and the wall is as much the ecology as the ruin." },
  { k: "Strata of Consequence", C: drawing("StrataOfConsequence"), rel: "causal", teaching: "The Hidden Ecology",
    d: "Six strata in section; a fault and a buried channel in the lowest bend every layer above, and the present surface is laid on the shape they left.",
    not: "Not a record. The top layer copies nothing beneath it and is free of nothing beneath it — that is retention as changed condition." },
  { k: "Ossuary and Crypt", C: drawing("OssuaryAndCrypt"), rel: "symbolic", teaching: "The Hidden Ecology",
    d: "Two marks: an arch with a stone lifted free of it, and the same arch's footprint pressed into layered ground.",
    not: "Two retentions, not one. Architecture can be taken; consequence can only be stood in." },
  ...
  { k: "The Tattva Ākāśa", C: drawing("TattvaCardAkasha"), rel: "symbolic", teaching: "The tattvas",
    d: "Ākāśa in its form and colour: the egg, black in the Golden Dawn’s cards and shown here as indigo.",
    not: "The egg is a convention of the cards, not a picture of ether; Prasad’s Ākāśa is dark and dotted, shaped like the hole of the ear." },
  { k: "The Tattva Vāyu", C: drawing("TattvaCardVayu"), rel: "symbolic", teaching: "The tattvas",
    d: "Vāyu in its form and colour: the blue circle.", not: "A flat disc as the cards drew it, not a globe; the colour is Prasad’s and the cards’, not a claim about air." },
  { k: "The Tattva Tejas", C: drawing("TattvaCardTejas"), rel: "symbolic", teaching: "The tattvas",
    d: "Tejas in its form and colour: the red triangle, apex up.", not: "Upward is the fire’s motion in the Indian sources, not a rank." },
  { k: "The Tattva Apas", C: drawing("TattvaCardApas"), rel: "symbolic", teaching: "The tattvas",
    d: "Apas in its form and colour: the crescent, white in Prasad and silver in the Golden Dawn.", not: "The horns-up crescent is the cards’ orientation; the Indian texts say only half-moon." },
  { k: "The Tattva Pṛthivī", C: drawing("TattvaCardPrithivi"), rel: "symbolic", teaching: "The tattvas",
    d: "Pṛthivī in its form and colour: the yellow square.", not: "An upright square, not a lozenge, and yellow rather than the house gold." },
