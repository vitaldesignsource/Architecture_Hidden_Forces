  ...
  return (
    <div className="mx-auto w-full max-w-[520px]">
      ...
      <svg viewBox="0 0 440 240" className="h-auto w-full" role="img" aria-labelledby="aoh-st-t">
        ...
        <text x={196} y={228} className="font-mono uppercase" style={{ fontSize: 6.4, letterSpacing: "0.14em" }} fill="var(--gold, #c9a227)" fillOpacity={0.7}>what occurred</text>
        ...
        <text x={110} y={230} textAnchor="middle" className="font-mono uppercase" style={{ fontSize: 6.4, letterSpacing: "0.14em" }} fill="var(--gold, #c9a227)" fillOpacity={0.7}>what was there</text>
        ...
        <text x={432} y={52} textAnchor="end" className="font-mono uppercase" style={{ fontSize: 6.8, letterSpacing: "0.16em" }} fill="currentColor" fillOpacity={0.55}>the present</text>
        <text x={432} y={214} textAnchor="end" className="font-mono uppercase" style={{ fontSize: 6.8, letterSpacing: "0.16em" }} fill="currentColor" fillOpacity={0.35}>the past</text>
      </svg>
    </div>
  );
}
