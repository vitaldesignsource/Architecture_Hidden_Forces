...
export function ProvincesAtlas() {
  ...
  return (
    <div className="aoh-fig aoh-fig-tight mx-auto w-full max-w-[720px]">
      <style>{`
      ...
      <svg viewBox="0 0 520 330" className="h-auto w-full" role="img" aria-labelledby="aoh-pa-t">
        ...
        <text x={492} y={40} textAnchor="end" className="font-label uppercase" style={lbl(6.6)} fill="currentColor" fillOpacity={0.55} stroke="var(--void, #000)" strokeWidth={3} strokeLinejoin="round" paintOrder="stroke">the Sea Between Causes</text>
        <text x={492} y={50} textAnchor="end" className="font-label uppercase hidden sm:block" style={lbl(6.2)} fill="currentColor" fillOpacity={0.55} stroke="var(--void, #000)" strokeWidth={3} strokeLinejoin="round" paintOrder="stroke">between every cause and its effect</text>
        {/* the waterline */}
        ...
        <text x={195} y={84} textAnchor="middle" className="font-label uppercase hidden sm:block" style={lbl(6.2)} fill="currentColor" fillOpacity={0.55}>before form · within Morphaithēr</text>
        ...
        <text x={cx} y={cy + 8} textAnchor="middle" className="font-label uppercase" style={lbl(6)} fill={G} fillOpacity={0.65}>one circulation</text>
        {/* the aquifer beneath */}
        ...
        <text x={250} y={294} textAnchor="middle" className="font-label uppercase hidden sm:block" style={lbl(6.2)} fill="currentColor" fillOpacity={0.55}>beneath · where the remainder sinks</text>
        ...
        <text x={414} y={238} textAnchor="middle" className="font-label uppercase hidden sm:block" style={lbl(6.2)} fill="currentColor" fillOpacity={0.55}>after the cult</text>
        ...
        <text x={412} y={180} textAnchor="middle" className="font-label uppercase hidden sm:block" style={lbl(6.2)} fill="currentColor" fillOpacity={0.55}>where residue acquires allure</text>
        ...
        <text x={112} y={286} textAnchor="middle" className="font-label uppercase hidden sm:block" style={lbl(6.2)} fill="currentColor" fillOpacity={0.55}>when circulation fails</text>
      </svg>
    </div>
  );
}
