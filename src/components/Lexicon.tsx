...
const ENTRIES: Entry[] = [
  ...
  { term: "Orthē schesis", script: "ὀρθὴ σχέσις", origin: "Greek", at: "relation", n: "XLIV",
    gloss: "Right relation — the dynamic proportion through which distinct beings participate in one another without losing their integrity." },
  { term: "Methexis", script: "μέθεξις", origin: "Greek", at: "relation", n: "XLIV",
    gloss: "Participation. A vessel enters real relation with a force without becoming identical to it, and is changed by the encounter." },
  { term: "The five terms", origin: "Coined", at: "relation", n: "XLIV",
    gloss: "Source, force, intermediary, vessel, field — the minimum set any operative relation contains, each with its own way of failing." },
  { term: "Right measure", origin: "Coined", at: "relation", n: "XLIV",
    gloss: "Not mediocrity: the amount of force that strengthens the vessel’s capacity for further right relation." },
  { term: "Right closure", origin: "Coined", at: "relation", n: "XLIV",
    gloss: "Ending a relation whose purpose is complete, so formative residue stops demanding energy. Deconsecration, farewell, burial, forgiveness." },
  { term: "Metastoicheiōsis", script: "μεταστοιχείωσις", origin: "Greek", at: "transformation", n: "XLVII",
    gloss: "Trans-elementation — transformation through the reordering of a being’s elemental relations in proportion, hierarchy and function." },
  { term: "The formative thread", origin: "Coined", at: "transformation", n: "XLVII",
    gloss: "The relation among essence, virtue and seedform that survives a metamorphosis — what makes the change belong to one being rather than being a replacement." },
  { term: "Sophia", script: "Σοφία", origin: "Greek", at: "sophia", n: "XLVI",
    gloss: "Wisdom as the intelligence of right relation — knowing not that a force exists but whether, through what, into what vessel, and to what end it should pass." },
  { term: "The Divine Feminine", origin: "Coined", at: "sophia", n: "XLVI",
    gloss: "Reception, gestation, mediation, formation and return as sacred capacities — receptivity as a formative power rather than passivity." },
  { term: "The Dark Feminine", origin: "Coined", at: "sophia", n: "XLVI",
    gloss: "The gestational, dissolving, nocturnal depth beneath the faces — Sophianic only while darkness serves transformation rather than captivity." },
  { term: "Spiritualisation", origin: "Coined", at: "matter", n: "XLV",
    gloss: "Not the escape from matter but its formation into an adequate vessel — increasing adequacy between an inner principle and its outward expression." },
  { term: "Heka", origin: "Coined", at: "heka", n: "XLVIII",
    gloss: "Operative power — hidden force made effective through an adequate chain of mediation. Not a rung but a mode of efficacy running through the whole chain." },
  { term: "Ma’at", origin: "Coined", at: "heka", n: "XLVIII",
    gloss: "Truth, balance, proportion — the measure of whether an operative pattern belongs in the order of the whole. Effective and rightful are not the same axis." },
  { term: "Sia and Hu", origin: "Coined", at: "heka", n: "XLVIII",
    gloss: "Perception and authoritative utterance. Sia perceives the pattern, Hu articulates it, Heka makes the articulated pattern operative." },
  { term: "Verbal synthema", origin: "Coined", at: "heka", n: "XLVIII",
    gloss: "A name as address rather than label — myth, attribute, function and authority gathered into one sound-form. It establishes a relationship, not a password." },
  { term: "Pneuma", script: "πνεῦμα", origin: "Greek", at: "microcosm", n: "XLIX",
    gloss: "Breath, spirit, animating current — not a possession held but a life repeatedly received, circulated and released." },
  { term: "Psychē", script: "ψυχή", origin: "Greek", at: "microcosm", n: "XLIX",
    gloss: "Soul as living intermediary: where universal forces become personal experience, and bodily impressions are raised into meaning." },
  { term: "Sōma", script: "σῶμα", origin: "Greek", at: "microcosm", n: "XLIX",
    gloss: "Body as organised living whole — not matter accumulated but matter arranged, maintained and continuously exchanged according to an active pattern." },
  { term: "The four offices", origin: "Coined", at: "microcosm", n: "XLIX",
    gloss: "Spirit animates without overwhelming, essence determines without fatalism, soul mediates without distortion, body embodies without claiming to be the whole." },
  { term: "The etheric body", origin: "Coined", at: "etheric", n: "L",
    gloss: "The vital-formative field — pattern acting as process, keeping identity through material turnover the way a flame or a melody does." },
  { term: "Etheric depletion", origin: "Coined", at: "etheric", n: "L",
    gloss: "Not an empty tank. Force may be present but trapped in defensive mobilisation or scattered across unfinished demands." },
  { term: "The astral body", origin: "Coined", at: "astral", n: "LI",
    gloss: "The image-bearing region where life becomes sensation, desire, aversion and motion. One region of the soul, not the whole of it." },
  { term: "Psychic complex", origin: "Coined", at: "astral", n: "LI",
    gloss: "Memory, emotion, bodily readiness, image and desire held together stably enough to organise perception around themselves." },
  { term: "Metaxy", script: "μεταξύ", origin: "Greek", at: "soul", n: "LII",
    gloss: "The active between. The soul does not merely occupy a middle position — it performs the translation by which spirit and matter become available to one another." },
  { term: "The interval", origin: "Coined", at: "soul", n: "LII",
    gloss: "The gaps between sensation, image, interpretation, belief and factual claim. Reality of experience does not establish correctness of interpretation." },
  { term: "Lived topology", origin: "Coined", at: "soul", n: "LII",
    gloss: "Subtle experience described by its qualities — expansion, contraction, direction, temperature — before any account of what caused it." },
  ...
  { term: "Solve et coagula", origin: "Latin", at: "transformation", n: "XLVII",
