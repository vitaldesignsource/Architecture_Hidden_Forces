...
export function FlashPair() {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,20rem)] lg:items-start">
      ...
      <div>
        <p className="font-label text-[10px] uppercase tracking-[0.25em] text-gold-dim">The field</p>
        ...
        <p className="mt-6 font-label text-[10px] uppercase tracking-[0.25em] text-gold-dim">The figure</p>
        <div className="mt-3 space-y-px">
          {MODES.map((m) => (
            <button key={m.k} onClick={() => setMode(m.k)} aria-pressed={mode === m.k}
              ...
              <span className={`font-label text-[10px] uppercase tracking-[0.14em] ${mode === m.k ? "text-gold" : "text-bone/70"}`}>
                {m.label}
              </span>
        ...
        <div className="mt-6 border-t border-border pt-4">
          <p className="font-label text-[10px] uppercase tracking-[0.15em] text-bone/50">
            Flash strength
          </p>
          ...
          <p className="mt-2 font-label text-[10px] uppercase tracking-[0.12em] text-muted-foreground">
...
export function Afterimage() {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,20rem)] lg:items-start">
      <div>
        ...
        >
          {phase === "stare" && (
            <>
              ...
              <p className="absolute bottom-4 font-label text-[11px] uppercase tracking-[0.2em] text-black/60">
                hold the cross · {left}
              </p>
            </>
          )}
          {phase === "after" && (
            <>
              ...
              <p className="absolute bottom-4 font-label text-[11px] uppercase tracking-[0.2em] text-black/50">
        ...
        {phase === "after" && (
          <button
            ...
            className="mt-3 border border-border px-4 py-2 font-label text-[9px] uppercase tracking-[0.18em] text-muted-foreground transition-colors hover:border-gold/40 hover:text-gold-dim"
          >
            Again
          </button>
        )}
      ...
      <div>
        <p className="font-label text-[10px] uppercase tracking-[0.25em] text-gold-dim">Stare at</p>
    ...
    <div>
      ...
      <div className="mt-4 flex flex-wrap items-center gap-4">
        <button
          ...
          className="border border-gold px-4 py-2 font-label text-[9px] uppercase tracking-[0.18em] text-gold transition-colors hover:bg-gold/10"
        >
    ...
    <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,17rem)] lg:items-start">
      <div className="overflow-x-auto">
        <table className="w-full min-w-[34rem] border-collapse">
          <thead>
            <tr>
              <th className="border-b border-border py-3 pr-3 text-left font-label text-[9.5px] uppercase tracking-[0.14em] text-gold-dim">
                Sephirah
              </th>
              {WORLDS.map((w) => (
      ...
      <div className="lg:border-l lg:border-border lg:pl-6">
        {sel && selName ? (
          <>
            ...
            <p className="mt-3 font-label text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
