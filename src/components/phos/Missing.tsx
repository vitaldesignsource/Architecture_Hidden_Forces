  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-void font-sans text-bone">
      ...
      <div className="mx-auto max-w-3xl px-6 pt-48 pb-32">
        <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gold">Not in the outline</p>
        ...
        <Link to="/phos/portal" className="mt-10 inline-block font-mono text-[10px] uppercase tracking-[0.25em] text-gold hover:underline">
          ← The Portal
        </Link>
      </div>
      <PhosFooter />
