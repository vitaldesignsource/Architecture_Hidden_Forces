  ...
  return (
    <figure className={compact ? "" : "my-14 border-t border-border pt-8"}>
      <figcaption className="mb-6 flex flex-wrap items-baseline gap-x-4 gap-y-2">
        <span className="font-label text-[10px] uppercase tracking-[0.3em] text-gold">Figure</span>
        <span className="font-serif text-xl text-bone">{f.k}</span>
        <span className="border border-gold/40 px-2 py-0.5 font-label text-[9px] uppercase tracking-[0.2em] text-gold-dim">
          {f.rel}
        </span>
      </figcaption>
      ...
      <Suspense
        fallback={
          <div
            aria-busy
            className="flex h-48 items-center justify-center font-label text-[10px] uppercase tracking-[0.3em] text-gold-dim/70"
          >
            Drawing the figure
          </div>
        }
      ...
      <div className="mt-8 grid gap-5 border-t border-border pt-5 sm:grid-cols-2">
        <div>
          <p className="font-label text-[9px] uppercase tracking-[0.25em] text-gold-dim">
            Reading — {f.rel}
          </p>
