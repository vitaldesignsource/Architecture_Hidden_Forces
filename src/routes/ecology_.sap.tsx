        ...
        <div className="grid gap-16 lg:grid-cols-[1fr_2fr]">
          ...
          <div>
            <p className="text-base leading-relaxed text-muted-foreground">
              ...
              crosses it is activated by Warmth, oriented by Light, differentiated by Tone and
              integrated by Life. The Sap is what crosses. So the four ethers are not four kinds of
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground">
              ...
              takes the Sap up; Light gives it direction; Tone gives it measure; Life gives it a
              body to be kept in. The nourishment that reaches a form has been through four
